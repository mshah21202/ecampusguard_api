...
class HomeScreenApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [HomeScreenDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<HomeScreenDto>> homeScreenGet({ 
...
_responseData = rawData == null ? null : deserialize<HomeScreenDto, HomeScreenDto>(rawData, 'HomeScreenDto', growable: true);
  ...
  Future<Response<List<NotificationDto>>> homeScreenNotificationsGet({ 
    ...
    final _path = r'/HomeScreen/notifications';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
