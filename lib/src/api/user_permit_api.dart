...
class UserPermitApi {
  ...
  Future<Response<JsonObject>> userPermitDetailsIdPost({ 
    required String id,
    JsonObject? body,
    ...
    final _path = r'/UserPermit/details/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> userPermitTransferIdPost({ 
    required String id,
    JsonObject? body,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/UserPermit/transfer/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
