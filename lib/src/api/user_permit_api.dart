...
_responseData = rawData == null ? null : deserialize<ResponseDto, ResponseDto>(rawData, 'ResponseDto', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [ResponseDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ResponseDto>> userPermitNotificationIdPost({ 
    required int id,
    ...
    final _path = r'/UserPermit/notification/{id}'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
...
_responseData = rawData == null ? null : deserialize<ResponseDto, ResponseDto>(rawData, 'ResponseDto', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [UserPermitDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserPermitDto>> userPermitRelevantGet({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/UserPermit/relevant';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
...
_responseData = rawData == null ? null : deserialize<ResponseDto, ResponseDto>(rawData, 'ResponseDto', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [ResponseDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ResponseDto>> userPermitWithdrawIdPost({ 
    required int id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/UserPermit/withdraw/{id}'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
